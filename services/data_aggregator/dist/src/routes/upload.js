...
const MAX_TABLE_SUFFIX_LEN = Math.max(TABLE_SUFFIX.length, BEST_SCHEDULES_TABLE_SUFFIX.length, BEST_PRUNED_CONFIG_TABLE_SUFFIX.length, PRUNING_EXPERIMENTS_TABLE_SUFFIX.length);
